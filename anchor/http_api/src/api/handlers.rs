...
pub fn create_router() -> Router {
    Router::new()
    .route("/api/v4/{network}/health", health_controller_health())
    .route("/api/v4/{network}/incentivization/merkle-tree", incentivization_controller_migration_operators_distribution())
    .route("/api/v4/{network}/operators/graph", operators_controller_graph())
    .route("/api/v4/{network}/operators/owned_by/{ownerAddress}", operators_controller_owned_by())
    .route("/api/v4/{network}/operators/incentivized/{operator}", operators_controller_incentivized())
    .route("/api/v4/{network}/operators/{operator}", operators_controller_get_operator())
    .route("/api/v4/{network}/operators/dkg_health_check", operators_controller_get_dkg_health_check())
    .route("/api/v4/{network}/operators/public_key/{public_key}", operators_controller_get_by_public_key())
    .route("/api/v4/{network}/operators", operators_controller_operators())
    .route("/api/v4/{network}/operators", operators_controller_get_by_ids())
    .route("/api/v4/{network}/operators/{operator}/metadata", operators_controller_update_metadata())
    .route("/api/v4/{network}/operators/nodes/{layer}", operators_controller_nodes())
    .route("/api/v4/{network}/operators/locations", operators_controller_locations())
    .route("/api/v4/{network}/search", search_controller())
    .route("/api/v4/{network}/validators/countActiveValidators", get_network_validators_count_active_validators())
    .route("/api/v4/{network}/validators/owned_by/{ownerAddress}/cost", validators_controller_cost())
    .route("/api/v4/{network}/validators/in_operator/{operator}", validators_controller_in_operator())
    .route("/api/v4/{network}/validators/incentivized/{validator}", validators_controller_incentivized())
    .route("/api/v4/{network}/validators/{validator}", validators_controller_validator())
    .route("/api/v4/{network}/validators/isRegisteredValidator/{validator}", validators_controller_validator())
    .route("/api/v4/{network}/validators/registeredByPublicKeys", create_network_validators_registered_by_public_keys())
    .route("/api/v4/{network}/validators", validators_controller_validators())
    .route("/api/v4/{network}/validators/duty_counts/{from_epoch}/{to_epoch}", validators_controller_duty_counts())
    .route("/api/v4/{network}/validators/validatorsByClusterHash/{clusterHash}", get_network_validators_validators_by_cluster_hash_cluster_hash())
    .route("/api/v4/{network}/validators/validatorsWithdrawCredentials", create_network_validators_validators_withdraw_credentials())
    .route("/api/v4/{network}/clusters/owner/{owner}/operators/{operators}", cluster_controller_by_owner_and_operators())
    .route("/api/v4/{network}/clusters/{id}", cluster_controller_by_id())
    .route("/api/v4/{network}/clusters/updates", cluster_controller_updates())
    .route("/api/v4/{network}/clusters/hash/{clusterHash}", cluster_controller_validators())
    .route("/api/v4/{network}/accounts", account_controller_list())
    .route("/api/v4/{network}/accounts/{ownerAddress}", account_controller_by_id())
    .route("/api/v4/{network}/accounts/counts/{ownerAddress}", get_network_accounts_counts_owner_address())
    .route("/api/v4/{network}/clusters/count", cluster_controller_count())
    .route("/api/v4/{network}/clusters", cluster_controller_list())    
}
...
pub async fn handle_get_api_v4_network_events_txHash() -> Result<JsonResponse<()>, StatusCode> {
